...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - 100 Days At Sea Wiki',
    description: 'Copyright and intellectual property information for 100 Days At Sea Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - 100 Days At Sea Wiki',
      description: 'Copyright and intellectual property information for 100 Days At Sea Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 100 Days At Sea Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of 100 Days At Sea Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              100 Days At Sea Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Stranded Devs</strong> - Creators of the 100 Days At Sea game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>100 Days At Sea</strong> - Trademark of the game developers</li>
              <li><strong>100 Days At Sea Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with 100 Days At Sea Wiki.
            </p>
            ...
            <p>
              ...
              100 Days At Sea Wiki<br />
              Email: <a href="mailto:dmca@100daysatseawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@100daysatseawiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "100 Days At Sea Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: 100 Days At Sea Wiki (100daysatseawiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@100daysatseawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@100daysatseawiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@100daysatseawiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@100daysatseawiki.wiki</a>
            </p>
            <p>
